        ...
        <TabsContent value="all" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end mb-10">
                ...
                <div className="order-2 md:order-1 relative">
                    <div className="aspect-[2/3] rounded-xl overflow-hidden shadow-[0_2px_6px_rgba(0,0,0,0.08)] border border-neutral-200 bg-white transform scale-90 origin-bottom">
                         <ImagePlaceholder />
                         <div className="absolute top-2 left-2 bg-gray-300 text-gray-800 font-bold px-3 py-1 rounded-xl shadow-sm">#2</div>
                    </div>
                ...
                <div className="order-1 md:order-2 relative z-10">
                    <div className="aspect-[2/3] rounded-xl overflow-hidden shadow-[0_2px_6px_rgba(0,0,0,0.08)] border-2 border-yellow-400 bg-white">
                         <ImagePlaceholder />
                         <div className="absolute top-0 right-0 p-4">
                             <div className="bg-yellow-400 text-yellow-900 font-bold w-10 h-10 rounded-full flex items-center justify-center shadow-sm text-lg">1</div>
                         </div>
                    </div>
                ...
                <div className="order-3 relative">
                    <div className="aspect-[2/3] rounded-xl overflow-hidden shadow-[0_2px_6px_rgba(0,0,0,0.08)] border border-neutral-200 bg-white transform scale-90 origin-bottom">
                         <ImagePlaceholder />
                         <div className="absolute top-2 left-2 bg-orange-200 text-orange-800 font-bold px-3 py-1 rounded-xl shadow-sm">#3</div>
                    </div>
                     <div className="text-center mt-2">
            ...
            {/* List Rankings 4-10 */}
            <div className="space-y-2 bg-white rounded-xl border border-neutral-200 shadow-[0_2px_6px_rgba(0,0,0,0.08)] p-6">
                {[4, 5, 6, 7, 8, 9, 10].map((rank) => (
                    <div key={rank} className="flex items-center gap-4 p-3 hover:bg-neutral-100 rounded-xl transition-colors group cursor-pointer">
